...
<pkg:package xmlns:pkg="http://schemas.microsoft.com/office/2006/xmlPackage">
    ...
    <pkg:part pkg:name="/word/_rels/document.xml.rels"
        ...
        <pkg:xmlData>
            <Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
                ...
                <#list images as item>
                    <Relationship Id="image${item_index+1}"
                                  Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image"
                                  Target="media/image${item_index+1}.${item.suffix}"/>
                </#list>
                                ...
                                <w:tc>
                                    ...
                                    <w:p>
                                        ...
                                        <w:r>
                                            ...
                                            <w:pict>
                                                <v:shape id="_x0000_i1025" o:spt="75" alt="2159314WsId"
                                                         type="#_x0000_t75"
                                                         style="height:79.2pt;width:202.2pt;" filled="f"
                                                         o:preferrelative="t" stroked="f" coordsize="21600,21600">
                                                    <v:path/>
                                                    <v:fill on="f" focussize="0,0"/>
                                                    <v:stroke on="f"/>
                                                    <v:imagedata r:id="image${item_index+1}" o:title="2159314WsId"/>
    ...
    <pkg:part pkg:name="/docProps/core.xml"
        ...
        <pkg:xmlData>
            <cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
                ...
                <dcterms:modified xsi:type="dcterms:W3CDTF">2023-03-08T01:07:16Z</dcterms:modified>
            </cp:coreProperties>
        </pkg:xmlData>
    </pkg:part>
        ...
        <pkg:xmlData>
            <Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/custom-properties"
                ...
                <property fmtid="{D5CDD505-2E9C-101B-9397-08002B2CF9AE}" pid="3" name="ICV">
                    <vt:lpwstr>A6BD312FFADE4F78B5A2C24DEFEA74B5</vt:lpwstr>
                </property>
            </Properties>
        </pkg:xmlData>
    </pkg:part>
    ...
    <#list images as item>
        <pkg:part pkg:name="/word/media/image${item_index+1}.${item.suffix}" pkg:contentType="image/${item.suffix}">
            <pkg:binaryData>${item.data}
            </pkg:binaryData>
        </pkg:part>
    </#list>
